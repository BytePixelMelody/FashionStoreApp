...
final class CheckoutViewController: UIViewController {
    ...
    private lazy var addAddressView = EmptyDetailsView(
        infoLabelText: Self.shippingAddressLabelTitle,
        addInfoButtonTitle: Self.addAddressButtonTitle,
        addInfoAction: editAddressAction
    )
    ...
    private lazy var addPaymentMethodView = EmptyDetailsView(
        infoLabelText: Self.paymentMethodLabelTitle,
        addInfoButtonTitle: Self.addPaymentMethodButtonTitle,
        addInfoAction: editPaymentMethodAction
    )
    ...
    private lazy var footerTotalPriceView = FooterTotalPriceView(
        ...
        buttonAction: placeOrderAction,
        buttonTitle: Self.placeOrderButtonTitle
    )
